...
export default function SearchBar() {
    ...
    const performWebSearch = (searchTerm: string) => {
        ...
        if (config) {
            const searchUrl = config.general.customSearchEnabled ? config.general.customSearchUrl : config.general.searchUrl
            window.location.href = searchUrl + encodeURIComponent(searchTerm);
        }
    }
