...
export default function SearchUrlPicker({ className, config, saveNewConfig, modifiedConfig, setModifiedConfig }: SearchUrlPickerProps) {
    ...
    return (
        <div className={`${className} grid grid-cols-1 md:grid-cols-2 gap-4`}>
            ...
            <Input disabled={!customSearchUrl} placeholder="Custom search url" defaultValue={modifiedConfig!.general.customSearchUrl} setValue={updateCustomSearchUrl} floatingLabel />
        </div>
    )
}
