...
export default function ProviderSettings({ config, modifiedConfig, setModifiedConfig, saveNewConfig }: SettingsSectionProps) {
                    ...
                    {modifiedConfig!.providers.map((provider) => (
                        <div className="flex flex-col gap-4 border border-nord-4 border-opacity-40 rounded p-2" key={provider.id}>
                            <div className="col-span-2">
                                <ProviderForm provider={provider} modifiedConfig={modifiedConfig} setModifiedConfig={setModifiedConfig} />
                            </div>
                            <div className="flex">
                                <div className="w-24">
