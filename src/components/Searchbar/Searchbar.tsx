  ...
  return (
    <form onSubmit={search}>
      <input
        ...
        ref={input}
        spellCheck="false"
        className="h-10 w-full border-0 border-b-2 border-accent/40 bg-transparent p-0 pb-4 pt-2 text-3xl outline-none placeholder:text-card-foreground/80 focus:border-accent/60 focus:ring-0"
