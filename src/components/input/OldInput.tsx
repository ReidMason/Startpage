...
import OldFormElementWrapper, {
  FormElementProps,
} from "../FormElementWrapper/OldFormElementWrapper";
  ...
  return (
    ...
    >
      <input
        ...
        {...register}
        className={`w-full ${inputState} ${inputVariant} ${pilledStyles} bg-primary-100/40 py-1.5 px-3 backdrop-blur transition duration-300 focus:bg-primary-100/60 focus:outline-none dark:text-primary-50`}
        type={textType}
        disabled={disabled}
